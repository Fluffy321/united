...
4. `migrations/004_core_feature_tables.sql`
...
- `004_core_feature_tables.sql` creates memberships, comments, reactions, notifications, and Mitzvah/Chesed workflow tables.
- These files also turn on basic security rules so users can only write the right kind of data.
