...
| `multipro-turf/` | Multipro Turf & Equipment — Greenacres FL | https://multipro-turf.vercel.app |
| `pizzaoli/` | Pizzaoli — kosher pizzeria, Davie FL | https://pizzaoli.vercel.app |
| `portfolio/` | Portfolio — sales page listing the work | not yet deployed |
