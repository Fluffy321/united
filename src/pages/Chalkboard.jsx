...
const boards = [
  ...
  { value: 'help_needed', label: '🆘 Help', color: 'bg-red-100 text-red-700' },
  { value: 'events', label: '📅 Events', color: 'bg-blue-100 text-blue-700' },
  { value: 'dating', label: '💕 Dating', color: 'bg-pink-100 text-pink-700', ageRestricted: true },
  { value: 'jobs', label: '💼 Jobs', color: 'bg-green-100 text-green-700' },
  { value: 'roommates', label: '🏠 Housing', color: 'bg-amber-100 text-amber-700' },
  { value: 'kosher_food', label: '🍽️ Food', color: 'bg-purple-100 text-purple-700' }
];
