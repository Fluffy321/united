...
export default function AIChatBubble({ currentUser, isScrollingDown }) {
  ...
  return (
    <div className={`fixed bottom-36 right-6 w-80 bg-white rounded-2xl shadow-2xl flex flex-col z-40 h-96 transition-transform duration-300 ${isScrollingDown ? 'translate-y-96' : 'translate-y-0'}`}>
      {/* Header */}
